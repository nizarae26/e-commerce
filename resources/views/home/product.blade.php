          ...
          <div class="row">
            ...
            <div class="col-md-6 col-xs-12 product-slider mb-60">
              ...
              <div class="gallery-thumbs">
                <div class="gallery-cell">
                  <img src="/uploads/{{$product->gambar}}jpg" alt="" />
                </div>
                <div class="gallery-cell">
                  <img src="/uploads/{{$product->gambar}}jpg" alt="" />
                </div>
            ...
            <div class="col-md-6 col-xs-12 product-description-wrap">
              ...
              <div class="color-swatches clearfix">
                ...
                <label for="{{$colour}}" style="margin-right: 15px;">{{$colour}}</label>
                @endforeach
              ...
              <div class="product-actions">
                ...
                <button type="submit" value="" href="#add-to-cart" class="btn btn-dark btn-lg add-to-cart"><span>Add to Cart</span></button>
                <!-- <a href="#add-to-cart" class="btn btn-dark btn-lg add-to-cart"><span>Add to Cart</span></a> -->
              ...
              <div class="product">
                <div class="product-item hover-trigger">
                  ...
                  <a href="/product/{{$produk->id}}">
                    ...
                    <a href="/product/{{$produk->id}}" class="product-quickview">Learn More</a>
                  </div>
