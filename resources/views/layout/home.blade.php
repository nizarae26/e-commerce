        ...
        <div class="container">
          <div class="top-bar-links flex-parent">
            <ul class="top-bar-currency-language">
              <li>
                Currency: <a href="/frontend/#">USD<i class="fa fa-angle-down"></i></a>
                <div class="currency-dropdown">
                  <ul>
                    <li><a href="/frontend/#">USD</a></li>
                    <li><a href="/frontend/#">EUR</a></li>
                  </ul>
                </div>
              </li>
              <li class="language">
                Language: <a href="/frontend/#">ENG<i class="fa fa-angle-down"></i></a>
                <div class="language-dropdown">
                  <ul>
                    <li><a href="/frontend/#">English</a></li>
                    <li><a href="/frontend/#">Spanish</a></li>
                    <li><a href="/frontend/#">German</a></li>
                    <li><a href="/frontend/#">Chinese</a></li>
                  </ul>
                </div>
              </li>
            </ul>
            ...
            <ul class="top-bar-acc">
              <li class="top-bar-link"><a href="/frontend/#">My Wishlist</a></li>
              <li class="top-bar-link"><a href="/frontend/#">Newsletter</a></li>
              <li class="top-bar-link"><a href="/frontend/#">Login</a></li>                 
            </ul>
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="widget footer-about-us">
                  <img src="/uploads/1234.png" alt="" class="logo">
                  <p class="mb-30">Antasena Shoes Shop is a Very Cheap and High Quality e-Commerce .</p>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-6 copyright sm-text-center">
                <span>
                  &copy; 2023 Antasena Shoes, Made by <a href="/frontend/http://deothemes.com">Nizarae</a>
                </span>
              </div>
